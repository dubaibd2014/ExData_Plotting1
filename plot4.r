...
plot(data.clean[,2],data.clean[,3],type='l',xlab='',ylab='Global Active Power')

plot(data.clean[,2],data.clean[,5],type='l',xlab='datetime',ylab='Voltage')
...
plot(data.clean[,2],data.clean[,4],type='l',xlab='datetime',ylab='Global_reactive_power')
